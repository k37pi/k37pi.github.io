      ...
      if (name.charAt(0).toUpperCase() + name.slice(1) === chrom[i])
         {
          ...
          var Locrian = [chrom[(i)%12].charAt(0).toLowerCase() + chrom[(i)%12].slice(1)+ ' dim ',
                         chrom[(i+1)%12].charAt(0).toUpperCase() + chrom[(i+1)%12].slice(1) + ' ',
                         chrom[(i+3)%12].charAt(0).toLowerCase() + chrom[(i+3)%12].slice(1) + ' ',
                         chrom[(i+5)%12].charAt(0).toLowerCase() + chrom[(i+5)%12].slice(1) + ' ',
                         chrom[(i+6)%12].charAt(0).toUpperCase() + chrom[(i+6)%12].slice(1) + ' ',
                         chrom[(i+8)%12].charAt(0).toUpperCase() + chrom[(i+8)%12].slice(1) + ' ',
                         chrom[(i+10)%12].charAt(0).toLowerCase() + chrom[(i+10)%12].slice(1),
